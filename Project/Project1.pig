-- Load the input file
episode = LOAD 'hdfs:///user/ramani/inputs/' USING PigStorage('\t') AS (character:chararray,dialogue:chararray);
...
STORE characterAccrces INTO 'hdfs:///user/ramani/proj1Reslt_whole';
